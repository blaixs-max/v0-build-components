    ...
    <article className="bg-card rounded-lg overflow-hidden shadow-sm">
      <Link href={`/ilan/${id}`} className="flex items-center gap-3 p-2">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button onClick={handleWhatsAppShare} className="p-1" aria-label="WhatsApp ile paylas">
            <svg viewBox="0 0 24 24" className="h-4 w-4 text-[#25D366] hover:text-[#128C7E] transition-colors" fill="currentColor">
